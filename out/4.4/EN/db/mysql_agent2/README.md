...
|MySQL|MySQL: Size of database {#DATABASE}|<p>-</p>|ZABBIX_PASSIVE|mysql.dbsize["{$MYSQL.HOST}","{$MYSQL.PORT}","{#DBNAME}"]<p>**Preprocessing**:</p><p>- DISCARD_UNCHANGED_HEARTBEAT: `1h`</p>|

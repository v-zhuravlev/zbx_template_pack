...
|Redis|Redis: Replication second offset{#SINGLETON}|<p>The replication offset reported by the slave</p>|DEPENDENT|redis.replication.second_repl_offset[{#SINGLETON}]<p>**Preprocessing**:</p><p>- JSONPATH: `$.Replication.second_repl_offset`</p>|

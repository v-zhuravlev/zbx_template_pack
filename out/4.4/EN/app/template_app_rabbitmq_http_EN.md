...
|RabbitMQ: has been restarted (uptime < 10m)|<p>Last value: {ITEM.LASTVALUE1}.</p><p>Uptime is less than 10 minutes</p>|`{TEMPLATE_NAME:rabbitmq.node.uptime.last()}<10m`|INFO|<p>Manual close: YES</p>|

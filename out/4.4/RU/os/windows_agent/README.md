...
|Group|Name|Description|Type|Key and additional info|
|-----|----|-----------|----|---------------------|
|Services|Service: State of "{#SERVICE.NAME}" ({#SERVICE.DISPLAYNAME})|<p>Information about a state of a service.</p>|ZABBIX_PASSIVE|service.info["{#SERVICE.NAME}",state]|
